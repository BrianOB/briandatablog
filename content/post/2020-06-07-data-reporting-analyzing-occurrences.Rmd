...
The two packages I use for this are *tidyverse*, which is my go-to package for any analysis because of its enhanced data-wrangling abilities, and *lubridate*, which is my go-to package for handling dates.
